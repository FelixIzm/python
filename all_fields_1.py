...
import sqlite3
conn = sqlite3.connect("./db/all_fields_1.db") # или :memory: чтобы сохранить в RAM
cursor = conn.cursor()
...
# место выбытия
url3='d=P~тульская обл&entity=000000011111110&entities=24,28,27,23,34,22,20,21&ps=100'
